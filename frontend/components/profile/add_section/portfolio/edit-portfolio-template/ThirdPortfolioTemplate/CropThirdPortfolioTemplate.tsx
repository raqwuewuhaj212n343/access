...
import { updateImageToDisplay } from "./ThirdPortfolioTemplate";

interface CropThirdPortfolioTemplateProps {
	headerTittle: string;
	openModal: boolean;
	handleClose: (
...
export const CropThirdPortfolioTemplate = (
	props: CropThirdPortfolioTemplateProps
) => {
	const style = {
...
export default CropThirdPortfolioTemplate;
