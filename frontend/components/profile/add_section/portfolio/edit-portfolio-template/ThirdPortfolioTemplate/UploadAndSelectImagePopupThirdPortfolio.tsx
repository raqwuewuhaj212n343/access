...
import CropPortfolioTemplate from "./CropThirdPortfolioTemplate";
...
interface UploadAndSelectImagePopupThirdPortfolioProps {
	headerTittle: string;
	openModal: boolean;
	handleClose: (event: MouseEvent<HTMLImageElement>) => void;
}
export const UploadAndSelectImagePopupThirdPortfolio = (
	props: UploadAndSelectImagePopupThirdPortfolioProps
) => {
	const style = {
...
export default UploadAndSelectImagePopupThirdPortfolio;
