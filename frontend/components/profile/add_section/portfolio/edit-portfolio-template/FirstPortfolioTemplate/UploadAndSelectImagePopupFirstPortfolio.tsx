...
import CropPortfolioTemplate from "./CropFirstPortfolioTemplate";
...
interface UploadAndSelectImagePopupProps {
	headerTittle: string;
	openModal: boolean;
	handleClose: (event: MouseEvent<HTMLImageElement>) => void;
}
export const UploadAndSelectImagePopup = (
	props: UploadAndSelectImagePopupProps
) => {
	const style = {
...
export default UploadAndSelectImagePopup;
