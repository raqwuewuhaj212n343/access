...
import { updateImageToDisplay } from "./FirstPortfolioTemplate";

interface CropPortfolioTemplateProps {
	headerTittle: string;
	openModal: boolean;
	handleClose: (
...
export const CropPortfolioTemplate = (props: CropPortfolioTemplateProps) => {
	const style = {
	...
	{
		/* Function used to upload only one image and used to set the image you clicked on before by this uploading image */
	}
	...
	let newImage = selectedImage ? selectedImage : imageToCrop;
	...
	{
		/* This function will allow to set the default image by the selected image when you upload a new image or by the cropped image */
	}
	const handleSaveImage = () => {
		...
		} else updateImageToDisplay(imageIdSelector!, newImage!);
	};
...
export default CropPortfolioTemplate;
